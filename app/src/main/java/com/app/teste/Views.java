...
public class Views{
    ...
    public void startGifAnimationGif1(){
        startGifAnimation(R.drawable.gif1, buttonCat1);
    }
    public void startGifAnimationGif2(){
        startGifAnimation(R.drawable.gif2, buttonCat2);
    }
